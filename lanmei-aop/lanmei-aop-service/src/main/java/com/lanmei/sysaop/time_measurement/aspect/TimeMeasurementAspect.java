package com.lanmei.sysaop.time_measurement.aspect;

import com.lanmei.aop.dao.model.TimeMeasurement;
import com.lanmei.sysaop.time_measurement.anno.TimeMeasurementAnno;
import com.lanmei.sysaop.time_measurement.service.TimeMeasurementService;
...
public class TimeMeasurementAspect {
	 ...
	 * 匹配注解TimeSpendAnno
	 */
	@Pointcut(value = "@annotation(com.lanmei.sysaop.time_measurement.anno.TimeMeasurementAnno)")
