...
public class SmsDemo {
    ...
    public static SendSmsResponse sendSms() throws ClientException {
        ...
        //必填:待发送手机号
        request.setPhoneNumbers("13925716752");
        //必填:短信签名-可在短信控制台中找到
        request.setSignName("蓝莓");
        //必填:短信模板-可在短信控制台中找到
        request.setTemplateCode("SMS_130916740");
        //可选:模板中的变量替换JSON串,如模板内容为"亲爱的${name},您的验证码为${code}"时,此处的值为
        request.setTemplateParam("{ \"code\":\"064958\"}");
    ...
    public static void send() throws ClientException, InterruptedException {

    	System.out.println("调用send----------------");
        //发短信
