...
insert into  `cms_admin`  value(15,201815,"77a7cc6a2effbe628d79e108f338ab91","fa277f0b8e831b92ea5c24266994369a","蓝莓15","赵云15","商品部",201800,"789456","MALE",19,NULL,"UNACTIVATE",
								"563739007@qq.com","EMAIL_ACTIVATED","12345678911","2018-04-27 16:48:00","0.1.1.1",0,
								"2018-04-27 16:48:00",NULL,NULL);
insert into  `cms_admin`  value(16,201816,"77a7cc6a2effbe628d79e108f338ab91","fa277f0b8e831b92ea5c24266994369a","蓝莓15","赵云16","商品部",201800,"789456","MALE",19,NULL,"UNACTIVATE",
								"563739007@qq.com","EMAIL_ACTIVATED","12345678911","2018-04-27 16:48:00","0.1.1.1",0,
								"2018-04-27 16:48:00",NULL,NULL);
insert into  `cms_admin`  value(17,201817,"77a7cc6a2effbe628d79e108f338ab91","fa277f0b8e831b92ea5c24266994369a","蓝莓15","赵云17","商品部",201800,"789456","MALE",19,NULL,"UNACTIVATE",
								"563739007@qq.com","EMAIL_ACTIVATED","12345678911","2018-04-27 16:48:00","0.1.1.1",0,
								"2018-04-27 16:48:00",NULL,NULL);
/*管理员登录表*/
...
CREATE TABLE `cms_admin_role`(
	`admin_role_id` INT  AUTO_INCREMENT COMMENT "管理员角色ID"  ,
	`admin_id`  INT  COMMENT "管理员ID",
	`role_id`    INT  COMMENT "角色ID",
	`create_time`  DATETIME  COMMENT "创建时间",
	`create_admin_id` INT COMMENT "创建人ID",
...
CREATE TABLE `cms_role`(
	...
	`role_flag`    VARCHAR(20)  COMMENT "角色标志",
	`state`  VARCHAR(20)  COMMENT "状态",
	`create_time`  DATETIME COMMENT "创建时间",
	`create_admin_id` INT COMMENT "创建人ID",
	`update_time`  DATETIME COMMENT "更新时间",
	`update_admin_id` INT COMMENT "更新人ID",
	`remark`  VARCHAR(200) COMMENT "备注信息",
	PRIMARY KEY (`role_id`)
	
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='角色表';
insert into cms_role values(1,"超级管理员","ADMIN","正常","2018-04-27 16:48:00",201801,NULL,NULL,"创建超级管理员");
insert into cms_role values(2,"会员管理员","USER","正常","2018-04-27 16:48:00",201801,NULL,NULL,"创建会员管理员");
insert into cms_role values(3,"商品管理员","COMMODITY","正常","2018-04-27 16:48:00",201801,NULL,NULL,"创建商品管理员");
/*角色权限关联表*/
DROP TABLE IF EXISTS `cms_role_permission`;
CREATE TABLE `cms_role_permission`(
	`role_permission_id` INT  AUTO_INCREMENT COMMENT "角色权限ID"  ,
